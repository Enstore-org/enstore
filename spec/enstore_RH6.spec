...
AutoReq: no
Prefix: opt/enstore
Requires: postgresql-libs, qpid-cpp-client-ssl, qpid-cpp-server-ssl, python-qpid-qmf,qpid-qmf,qpid-cpp-server,python-qpid,qpid-tools, qpid-cpp-client
