...
ftt_dev_entry devtable[] = {
    ...
    /* Descriptive/translators */
        ...
        { "dev/rmt%d.1",       -1,  0, 0x00, 0,  1,          FTT_RDNW, 0, 512},
    ...
    /*   ======                  === === ===   === === ======            === */
        ...
        { "dev/rmt%d.5",       -1,  0,   -1, 1,  0,                 0, 0, EXB_MAX_BLKSIZE},
    /* Usable, variable */
        { "dev/rmt%d.1",        0,  0, 0x14, 0,  0,                 0, 1, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.1",        0,  1, 0x90, 0,  0,                 0, 0, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.5",        1,  1, 0x8c, 0,  0,                 0, 0, EXB_MAX_BLKSIZE},
    /* Usable Fixed */
        { "dev/rmt%d.1",        0,  0, 0x14, 0,  1,                 0, 0, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.1",        0,  1, 0x90, 0,  1,                 0, 0, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.5",        1,  0, 0x15, 0,  1,                 0, 0, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.5",        1,  1, 0x8c, 0,  1,                 0, 0, EXB_MAX_BLKSIZE},
   /* Descriptive */
        { "dev/rmt%d",          0,  0, 0x14, 0,  1, FTT_RWOC|       0, 1, 512},
        { "dev/rmt%d.5",        1,  0, 0x00, 0,  1,                 0, 0, 512},
        { "dev/rmt%d.1",        0,  0, 0x14, 0,  1,          FTT_RDNW, 0, 512},
        { "dev/rmt%d.1",        0,  1, 0x15, 0,  1,          FTT_RDNW, 0, 512},
        { "dev/rmt%d.5",        1,  0, 0x8c, 0,  1,          FTT_RDNW, 0, 512},
        { "dev/rmt%d.5",        1,  1, 0x90, 0,  1,          FTT_RDNW, 0, 512},
        { "dev/rmt%d.2",        0,  0, 0x14, 0,  1, FTT_RWOC|FTT_RTOO, 1, 512},
        { "dev/rmt%d.3",        0,  0, 0x14, 0,  1,          FTT_RTOO, 1, 512},
        { "dev/rmt%d.4",        1,  0, 0x00, 0,  0, FTT_RWOC|       0, 1, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.6",        1,  0, 0x00, 0,  0, FTT_RWOC|FTT_RTOO, 1, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.7",        1,  0, 0x00, 0,  0,        0|FTT_RTOO, 1, EXB_MAX_BLKSIZE},
        { 0, },
    }},
    ...
    /* Fixed Usable */
        ...
        { "dev/rmt%d.5",        1,  0, 0x15, 0,  1,                 0, 0, EXB_MAX_BLKSIZE},
    /* Descriptive */
        { "dev/rmt%d",          0,  0, 0x14, 0,  1, FTT_RWOC|       0, 1, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.2",        0,  0, 0x14, 0,  1, FTT_RWOC|FTT_RTOO, 1, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.3",        0,  0, 0x14, 0,  1,          FTT_RTOO, 1, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.4",        1,  0, 0x00, 0,  1, FTT_RWOC|       0, 1, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.4",        1,  0, 0x15, 0,  1, FTT_RWOC|       0, 0, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.6",        1,  0, 0x15, 0,  1, FTT_RWOC|FTT_RTOO, 1, EXB_MAX_BLKSIZE},
        { "dev/rmt%d.7",        1,  0, 0x15, 0,  1,        0|FTT_RTOO, 1, EXB_MAX_BLKSIZE},
        { 0, },
    }},
...
FTT_OP_STATUS|FTT_OP_GET_STATUS,ftt_trans_table_AIX, Exabyte_density_trans,
	...
	{ "rmt/tps%dd%dnr.8200c",    0,  1,0x14, 0,  1,                 0, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnr.8500",     1,  0,0x15, 0,  1,                 0, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnr.8500c",    1,  1,0x15, 0,  1,                 0, 1, IRIX_MAX_BLKSIZE},
	...
	{ "rmt/tps%dd%dnrs.8200c",   0,  1,0x14, 0,  1,          FTT_BTSW, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnrs.8500",    1,  0,0x15, 0,  1,          FTT_BTSW, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnrs.8500c",   1,  1,0x15, 0,  1,          FTT_BTSW, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnrsv",        1,  0,0x15, 0,  0,          FTT_BTSW, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnrsv.8200",   0,  0,0x14, 0,  0,          FTT_BTSW, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnrsv.8200c",  0,  1,0x14, 0,  0,          FTT_BTSW, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnrsv.8500",   1,  0,0x15, 0,  0,          FTT_BTSW, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnrsv.8500c",  1,  1,0x15, 0,  0,          FTT_BTSW, 1, IRIX_MAX_BLKSIZE},
	...
	{ "rmt/tps%dd%dns.8200c",    0,  1,0x14, 0,  1,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dns.8500",     1,  0,0x15, 0,  1,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dns.8500c",    1,  1,0x15, 0,  1,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnsv",         1,  0,0x15, 0,  0,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnsv.8200",    0,  0,0x14, 0,  0,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnsv.8200c",   0,  1,0x14, 0,  0,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnsv.8500",    1,  0,0x15, 0,  0,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dnsv.8500c",   1,  1,0x15, 0,  0,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	...
	{ "rmt/tps%dd%ds.8200c",     0,  1,0x14, 0,  1, FTT_BTSW|FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%ds.8500",      1,  0,0x15, 0,  1, FTT_BTSW|FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%ds.8500c",     1,  1,0x15, 0,  1, FTT_BTSW|FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	...
	{ "rmt/tps%dd%dsv.8200c",    0,  1,0x14, 0,  0, FTT_BTSW|FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dsv.8500",     1,  0,0x15, 0,  0, FTT_BTSW|FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dsv.8500c",    1,  1,0x15, 0,  0, FTT_BTSW|FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dv",           1,  0,0x15, 0,  0,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dv.8200",      0,  0,0x14, 0,  0,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dv.8200c",     0,  1,0x14, 0,  0,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dv.8500",      1,  0,0x15, 0,  0,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
	{ "rmt/tps%dd%dv.8500c",     1,  1,0x15, 0,  0,          FTT_RWOC, 1, IRIX_MAX_BLKSIZE},
        { 0,},
    }},
