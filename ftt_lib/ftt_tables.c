...
ftt_dev_entry devtable[] = {
    ...
    {"Linux", "EXB-82", "SCSI",  FTT_FLAG_VERIFY_EOFS|FTT_FLAG_BSIZE_AFTER , FTT_OP_GET_STATUS, ftt_trans_table, Exabyte_density_trans,
       "dev/%*[ns]t%d", "dev/nst%d", 1, LINUXfind, {
    /*   string          den mod hwd  pas fxd rewind   1st */
    /*   ======          === === ===  === === ======   === */
    /* Default */
    ...
    /* Densitites */
       ...
       { "rmt/%dbn", 	  1,  0,  0,    0,  0,                 0, 1, SUN_MAX_BLKSIZE},
       ...
       { "rmt/%dcbn", 	  1,  0,  0,    0,  0,                 0, 1, SUN_MAX_BLKSIZE},
       { "rmt/%dcn", 	  1,  0,  0,    0,  0,                 0, 1, SUN_MAX_BLKSIZE},
       { "rmt/%dn", 	  1,  0,  0,    0,  0,                 0, 1, SUN_MAX_BLKSIZE},
       { 0 },
    }},
...
ftt_stat_entry ftt_stat_op_tab[] = {
    ...
    {"2DLT",      
	FTT_DO_VSRS|
	FTT_DO_TUR|FTT_DO_INQ|FTT_DO_MS|FTT_DO_MS_Px0f|FTT_DO_MS_Px10|FTT_DO_RS|
