...
ftt_dev_entry devtable[] = {
	...
	{ "/dev/rmt/tps%dd%dnrv",   5,  0,0x1A, 0,  0,                 0, 0},
	{ "/dev/rmt/tps%dd%dns",    5,  0,0x1A, 0,  1,          FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrns",  5,  0,0x1A, 0,  1,                 0, 1},
	{ "/dev/rmt/tps%dd%dnsv",   5,  0,0x1A, 0,  0,          FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrnsv", 5,  0,0x1A, 0,  0,                 0, 1},
	{ "/dev/rmt/tps%dd%ds",     5,  0,0x1A, 0,  1, FTT_BTSW|FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrs" ,  5,  0,0x1A, 0,  1,          FTT_BTSW, 1},
	{ "/dev/rmt/tps%dd%dsv",    5,  0,0x1A, 0,  0, FTT_BTSW|FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrsv ", 5,  0,0x1A, 0,  0,          FTT_BTSW, 1},
	{ "/dev/rmt/tps%dd%dc",     5,  0,0x1A, 0,  1,          FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrc",   5,  1,0x1A, 0,  1,                 0, 1},
	{ "/dev/rmt/tps%dd%dvc",    5,  1,0x1A, 0,  0,          FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrvc",  5,  1,0x1A, 0,  0,                 0, 1},
	{ "/dev/rmt/tps%dd%dnsc",   5,  1,0x1A, 0,  1,          FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrnsc", 5,  1,0x1A, 0,  1,                 0, 1},
	{ "/dev/rmt/tps%dd%dnsvc",  5,  1,0x1A, 0,  0,          FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrnsvc",5,  1,0x1A, 0,  0,                 0, 1},
	{ "/dev/rmt/tps%dd%dsc",    5,  1,0x1A, 0,  1, FTT_BTSW|FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrsc" , 5,  1,0x1A, 0,  1,          FTT_BTSW, 1},
	{ "/dev/rmt/tps%dd%dsvc",   5,  1,0x1A, 0,  0, FTT_BTSW|FTT_RWOC, 1},
	...
	{ "/dev/rmt/tps%dd%dns",          1,  0,0x15, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%dnrns",        1,  0,0x15, 0,  1,                 0, 0},
	{ "/dev/rmt/tps%dd%dnsv",         1,  0,0x15, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%dnrnsv",       1,  0,0x15, 0,  0,                 0, 0},
	{ "/dev/rmt/tps%dd%dns.8200",     0,  0,0x14, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%dnrns.8200",   0,  0,0x14, 0,  1,                 0, 0},
	{ "/dev/rmt/tps%dd%dnsv.8200",    0,  0,0x14, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%dnrnsv.8200",  0,  0,0x14, 0,  0,                 0, 0},
	{ "/dev/rmt/tps%dd%dns.8500",     1,  0,0x15, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%dnrns.8500",   1,  0,0x15, 0,  1,                 0, 0},
	{ "/dev/rmt/tps%dd%dnrnsv.8500",  1,  0,0x15, 0,  0,                 0, 0},
	{ "/dev/rmt/tps%dd%dnsv.8500",    1,  0,0x15, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%ds",           1,  0,0x15, 0,  1, FTT_BTSW|FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%dnrs",         1,  0,0x15, 0,  1,          FTT_BTSW, 0},
	{ "/dev/rmt/tps%dd%dsv",          1,  0,0x15, 0,  0, FTT_BTSW|FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%dnrsv",        1,  0,0x15, 0,  0,          FTT_BTSW, 0},
	{ "/dev/rmt/tps%dd%ds.8200",      0,  0,0x14, 0,  1, FTT_BTSW|FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%dnrs.8200",    0,  0,0x14, 0,  1,          FTT_BTSW, 0},
	{ "/dev/rmt/tps%dd%dsv.8200",     0,  0,0x14, 0,  0, FTT_BTSW|FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%dnrsv.8200",   0,  0,0x14, 0,  0,          FTT_BTSW, 0},
	{ "/dev/rmt/tps%dd%ds.8500",      1,  0,0x15, 0,  1, FTT_BTSW|FTT_RWOC, 0},
	{ "/dev/rmt/tps%dd%dnrs.8500",    1,  0,0x15, 0,  1,          FTT_BTSW, 0},
	{ "/dev/rmt/tps%dd%dnrsv.8500",   1,  0,0x15, 0,  0,          FTT_BTSW, 0},
	...
	{ "/dev/scsi/sc%dd%dl0",         -2,  0,   0, 1,  0,                 0, 1},
	{ "/dev/rmt/tps%dd%dstat",       -1,  0,   0, 0,  0,                 0, 1},
	...
	{ "/dev/rmt/tps%dd%dnrns",        0,  0,   0, 0,  1,                 0, 0},
	{ "/dev/rmt/tps%dd%dns",          0,  0,   0, 0,  1,          FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrnsv",       0,  0,   0, 0,  0,                 0, 1},
	{ "/dev/rmt/tps%dd%dnsv",         0,  0,   0, 0,  0,          FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrs",         0,  0,   0, 0,  1,          FTT_BTSW, 1},
	{ "/dev/rmt/tps%dd%ds",           0,  0,   0, 0,  1, FTT_BTSW|FTT_RWOC, 1},
	{ "/dev/rmt/tps%dd%dnrsv",        0,  0,   0, 0,  0,          FTT_BTSW, 1},
	...
	{ "/dev/rmt/jag%dd%dnr",    1,  0,0x0A, 0,  1,                 0, 1},
	{ "/dev/rmt/jag%dd%dv",     1,  0,0x0A, 0,  0,          FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrv",   1,  0,0x0A, 0,  0,                 0, 0},
	{ "/dev/rmt/jag%dd%d",      2,  0,0x16, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnr",    2,  0,0x16, 0,  1,                 0, 0},
	{ "/dev/rmt/jag%dd%dv",     2,  0,0x16, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrv",   2,  0,0x16, 0,  0,                 0, 0},
	{ "/dev/rmt/jag%dd%d",      3,  0,0x17, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnr",    3,  0,0x17, 0,  1,                 0, 0},
	{ "/dev/rmt/jag%dd%dv",     3,  0,0x17, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrv",   3,  0,0x17, 0,  0,                 0, 0},
	{ "/dev/rmt/jag%dd%d",      4,  0,0x18, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnr",    4,  0,0x18, 0,  1,                 0, 0},
	{ "/dev/rmt/jag%dd%dv",     4,  0,0x18, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrv",   4,  0,0x18, 0,  0,                 0, 0},
	{ "/dev/rmt/jag%dd%d",      5,  0,0x00, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnr",    5,  0,0x00, 0,  1,                 0, 0},
	{ "/dev/rmt/jag%dd%dv",     5,  0,0x00, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrv",   5,  0,0x00, 0,  0,                 0, 0},
	{ "/dev/rmt/jag%dd%d",      5,  0,0x1A, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnr",    5,  0,0x1A, 0,  1,                 0, 0},
	{ "/dev/rmt/jag%dd%dv",     5,  0,0x1A, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrv",   5,  0,0x1A, 0,  0,                 0, 0},
	{ "/dev/rmt/jag%dd%dns",    5,  0,0x1A, 0,  1,          FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrns",  5,  0,0x1A, 0,  1,                 0, 1},
	{ "/dev/rmt/jag%dd%dnsv",   5,  0,0x1A, 0,  0,          FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrnsv", 5,  0,0x1A, 0,  0,                 0, 1},
	{ "/dev/rmt/jag%dd%ds",     5,  0,0x1A, 0,  1, FTT_BTSW|FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrs" ,  5,  0,0x1A, 0,  1,          FTT_BTSW, 1},
	{ "/dev/rmt/jag%dd%dsv",    5,  0,0x1A, 0,  0, FTT_BTSW|FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrsv ", 5,  0,0x1A, 0,  0,          FTT_BTSW, 1},
	{ "/dev/rmt/jag%dd%dc",     5,  0,0x1A, 0,  1,          FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrc",   5,  1,0x1A, 0,  1,                 0, 1},
	{ "/dev/rmt/jag%dd%dvc",    5,  1,0x1A, 0,  0,          FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrvc",  5,  1,0x1A, 0,  0,                 0, 1},
	{ "/dev/rmt/jag%dd%dnsc",   5,  1,0x1A, 0,  1,          FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrnsc", 5,  1,0x1A, 0,  1,                 0, 1},
	{ "/dev/rmt/jag%dd%dnsvc",  5,  1,0x1A, 0,  0,          FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrnsvc",5,  1,0x1A, 0,  0,                 0, 1},
	{ "/dev/rmt/jag%dd%dsc",    5,  1,0x1A, 0,  1, FTT_BTSW|FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrsc" , 5,  1,0x1A, 0,  1,          FTT_BTSW, 1},
	{ "/dev/rmt/jag%dd%dsvc",   5,  1,0x1A, 0,  0, FTT_BTSW|FTT_RWOC, 1},
	...
	{ "/dev/rmt/jag%dd%dns",          1,  0,0x15, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrns",        1,  0,0x15, 0,  1,                 0, 0},
	{ "/dev/rmt/jag%dd%dnsv",         1,  0,0x15, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrnsv",       1,  0,0x15, 0,  0,                 0, 0},
	{ "/dev/rmt/jag%dd%dns.8200",     0,  0,0x14, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrns.8200",   0,  0,0x14, 0,  1,                 0, 0},
	{ "/dev/rmt/jag%dd%dnsv.8200",    0,  0,0x14, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrnsv.8200",  0,  0,0x14, 0,  0,                 0, 0},
	{ "/dev/rmt/jag%dd%dns.8500",     1,  0,0x15, 0,  1,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrns.8500",   1,  0,0x15, 0,  1,                 0, 0},
	{ "/dev/rmt/jag%dd%dnrnsv.8500",  1,  0,0x15, 0,  0,                 0, 0},
	{ "/dev/rmt/jag%dd%dnsv.8500",    1,  0,0x15, 0,  0,          FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%ds",           1,  0,0x15, 0,  1, FTT_BTSW|FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrs",         1,  0,0x15, 0,  1,          FTT_BTSW, 0},
	{ "/dev/rmt/jag%dd%dsv",          1,  0,0x15, 0,  0, FTT_BTSW|FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrsv",        1,  0,0x15, 0,  0,          FTT_BTSW, 0},
	{ "/dev/rmt/jag%dd%ds.8200",      0,  0,0x14, 0,  1, FTT_BTSW|FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrs.8200",    0,  0,0x14, 0,  1,          FTT_BTSW, 0},
	{ "/dev/rmt/jag%dd%dsv.8200",     0,  0,0x14, 0,  0, FTT_BTSW|FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrsv.8200",   0,  0,0x14, 0,  0,          FTT_BTSW, 0},
	{ "/dev/rmt/jag%dd%ds.8500",      1,  0,0x15, 0,  1, FTT_BTSW|FTT_RWOC, 0},
	{ "/dev/rmt/jag%dd%dnrs.8500",    1,  0,0x15, 0,  1,          FTT_BTSW, 0},
	{ "/dev/rmt/jag%dd%dnrsv.8500",   1,  0,0x15, 0,  0,          FTT_BTSW, 0},
	...
	{ "/dev/rmt/jag%dd%dnrns",        0,  0,   0, 0,  1,                 0, 0},
	{ "/dev/rmt/jag%dd%dns",          0,  0,   0, 0,  1,          FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrnsv",       0,  0,   0, 0,  0,                 0, 1},
	{ "/dev/rmt/jag%dd%dnsv",         0,  0,   0, 0,  0,          FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrs",         0,  0,   0, 0,  1,          FTT_BTSW, 1},
	{ "/dev/rmt/jag%dd%ds",           0,  0,   0, 0,  1, FTT_BTSW|FTT_RWOC, 1},
	{ "/dev/rmt/jag%dd%dnrsv",        0,  0,   0, 0,  0,          FTT_BTSW, 1},
