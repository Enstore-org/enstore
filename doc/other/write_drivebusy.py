...
p = sequence.Uml_sequence_page("WRITE_DRIVEBUSY -- impossible because of precautionary dismount")
...
p.add_message(sequence.Uml_message (amu, arm, "(tape is transported to shelf)"))
p.add_message(sequence.Uml_message (amu, mc, "DISMOUNT done"))
