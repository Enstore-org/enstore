...
class SummaryBpdPlotterModule(bytes_per_day_plotter_module.BytesPerDayPlotterModule):
    def __init__(self,name,isActive=True):
        bytes_per_day_plotter_module.BytesPerDayPlotterModule.__init__(self,name,isActive)
