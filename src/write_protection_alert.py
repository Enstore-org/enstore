...
def do_work(file_name):
    ...
    wpa_media_types = inventory.get('wpa_media_types',["9940", "9940B", "LTO3", "LTO4"])
    wpa_excluded_libraries = inventory.get('wpa_excluded_libraries', ["null1", "disk", "test", "CD-LTO4G1T"])
