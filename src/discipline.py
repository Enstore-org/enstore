...
class Restrictor:
    ...
    def match_found(self, ticket):
        ...
        # function name to run when match was founsd
        ...
        for key in self.dict.keys():
            ...
            if self.ticket_match(key, host) == 1:
                ...
                match = 1, self.dict[key]['function'], copy.deepcopy(self.dict[key]['args']),self.dict[key]['action']
                break
