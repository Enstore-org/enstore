...
class EstartInterface(generic_client.GenericClientInterface):
    ...
    def valid_dictionaries(self):
        return (self.help_options, self.estart_options)
...
def do_work(intf):
    ...
    cmd = "(source /usr/local/etc/setups.sh; setup enstore; enstore start)" \
          " >&1- 2>&- <&- &"
