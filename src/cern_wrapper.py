...
if __name__ == "__main__":            
    ...
    ticket = {'routing_callback_addr': ('131.225.84.56', 38515),
              ...
              'wrapper': {'minor': 0, 'inode': 0,
                          ...
                          'mode': 32782,
                          'pstat': (16877, 71385560, 10L, 1, 1012, 1530, 512, 1022690337, 1022690337, 1014315760),
              ...
              'vc': {'first_access': -1, 'sum_rd_err': 0, 'last_access': -1,
                     'file_family_width': 1, 'capacity_bytes': 64424509440L,
                     'declared': 1022689718.7261389,
                     'remaining_bytes': 64424509440L, 'wrapper': 'cern',
                     'external_label': 'EFB000',
