...
class EnstoreSystemHtml:
    def __init__(self, name, bytes_dict, remote=False):
        ...
        global_table = HTMLgen.TableLite(
        ...
        # User Data Table
        ###
        self.user_data_table = HTMLgen.TableLite(
            cellpadding=2, cellspacing=2, border=4)
        ...
        # Info Table
        ###
        self.info_table = HTMLgen.TableLite(
            cellpadding=2, bgcolor=TABLECOLOR, cellspacing=5, border=2)
