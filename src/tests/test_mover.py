...
class TestMoverMisc(unittest.TestCase):
    ...
    def test_is_threshold_passed(self):
       ...
       bytes_notified = 0
       bytes_to_transfer = 0
       self.assertEqual(1, is_threshold_passed(bytes_transfered, bytes_notified, bytes_to_transfer,t))
       bytes_notified = 10
       bytes_to_transfer = 100
       self.assertEqual(0, is_threshold_passed(bytes_transfered, bytes_notified, bytes_to_transfer,t))
