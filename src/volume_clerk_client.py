...
def sumup(a):
    # symple type?
    if isinstance(a, int) or isinstance(a, long) or \
            isinstance(a, float):  # number
        return a
        ...
        if len(a) == 1:		# character
            ...
            return sumation
    elif isinstance(a, list):  # list
        sumation = 0
        for i in a:
            sumation = sumation + sumup(i)
        return sumation
    elif isinstance(a, dict):  # dictionary
        sumation = 0
        for i in a.keys():
