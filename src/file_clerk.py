...
SELECT_FILES_IN_TRANSITION="select f.bfid, f.cache_status, f.cache_mod_time from file f where f.bfid in (select bfid from files_in_transition) and f.archive_status != 'ARCHIVED' and f.cache_status='CACHED' and f.deleted='n' and f.cache_mod_time <  CURRENT_TIMESTAMP - interval '1 day' "
