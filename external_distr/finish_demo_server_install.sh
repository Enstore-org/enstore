...
rpm -U --force ${psql_place}/postgresql-libs-8.2.4-1PGDG.i686.rpm ${psql_place}/postgresql-8.2.4-1PGDG.i686.rpm ${psql_place}/postgresql-server-8.2.4-1PGDG.i686.rpm ${psql_place}/postgresql-devel-8.2.4-1PGDG.i686.rpm
fi
...
rpm -U --force http://www.dcache.org/downloads/releases/pnfs-postgresql-3.1.10-7.i386.rpm
