...
(0x04, 0x02) : 'LOAD COMMAND NEEDED',
(0x04, 0x03) : 'MANUAL INTERVENTION NEEDED',
(0x09, 0x00) : 'TRACK-FOLLOWING-ERROR',
(0x0a, 0x00) : 'ERROR-LOG_OVERFLOW',
...
(0x80, 0x01) : 'CLEANING-REQUIRED (DLT)',
(0x80, 0x02) : 'CLEANING-REQUESTED (DLT)'
}
