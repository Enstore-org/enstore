...
#
# Make the following use an environment variable so noone has to edit this file
#ARCHIVE = "."  
import os
ARCHIVE = os.environ['GADFLY_GRAMMAR']
...
#   we no longer need to print the buildinfo as it works off of an environment
#   variable
#    print buildinfo
